...
/****************************************************************************
** Meta object code from reading C++ file 'waiter.h'
**
...
#error "The header file 'waiter.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 7, 7), // "paybill"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 8) // "connetdb"

    },
    "waiter\0paybill\0\0connetdb"
};
...
void waiter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->paybill(); break;
        case 1: _t->connetdb(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject waiter::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_waiter.data,
      qt_meta_data_waiter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
